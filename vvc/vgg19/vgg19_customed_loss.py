...
if __name__ == '__main__':
    ...
    #plot_model(vgg19,to_file='./VVC_train_record/vgg19.png',show_shapes=True)
    #print(vgg19.summary())
    print("== LOADING DATA... ==")
    # load data
    num_classes = 2
    ...
    for train, test in sfolder.split(images, labels):
        ...
        #cbks = [TensorBoard(log_dir='./VVC_train_record/vvc_vgg19_{}/'.format(args.dataset),histogram_freq=1),LearningRateScheduler(scheduler)]   
        metrics= Metric()
        ...
        vgg19.save('./vgg19_train_record/vvc_vgg19_customed_loss.h5')
