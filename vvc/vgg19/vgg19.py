...
if __name__ == '__main__':
    ...
    for train, test in sfolder.split(images, labels):
        ...
        cbks = [metrics, TensorBoard(log_dir='./vgg19_train_record/vgg19/',    histogram_freq=1),                LearningRateScheduler(scheduler)]
        ...
        print('The current running python file is:vgg19.py,83:21,validation_data=(x_test, y_test),batchsize=8,epochs=150,categorical_crossentropy ,sgd')
        print('\n')       
        # evaluate the model
        scores = vgg19.evaluate(x_test, y_test, verbose=0)
        vgg19.save('./vgg19_train_record/vgg19.h5')
