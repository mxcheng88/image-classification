...
if __name__ == '__main__':
    ...
    print("========================================")
    print("MODEL: Residual Network 50 Oversampling")
    ...
    for train, test in sfolder.split(images, labels):
        ...
        metrics= Metric() 
        cbks = [metrics, TensorBoard(log_dir='./vgg19_train_record/vgg19_oversampling/',                            histogram_freq=1),                LearningRateScheduler(scheduler)]
        ...
        plt.savefig('./vgg19_oversampling.png')
        #plt.show()
        print('\n')
        print()
        print (time.strftime('%Y-%m-%d %H:%M:%S',time.localtime()))
        print('The current running python file is:vgg19_oversampling.py,83:21,validation_data=(x_test, y_test),batchsize=8,epochs=150,categorical_crossentropy ,sgd')
        print('\n')   
        # evaluate the model
        scores = vgg19.evaluate(x_test, y_test, verbose=0)
        vgg19.save('./vgg19_train_record/vgg19_oversampling.h5')
