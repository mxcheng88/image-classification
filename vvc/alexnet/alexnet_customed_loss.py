...
if __name__ == '__main__':
    ...
    for train, test in sfolder.split(images, labels):
        ...
        metrics= Metric()
        cbks = [metrics, TensorBoard(log_dir='./alexnet_train_record/alexnet_customed_loss/',          histogram_freq=1),                LearningRateScheduler(scheduler)]
        ...
        plt.savefig('./alexnet_customed_loss.png')
        #plt.show()
        print('\n')
        ...
        alexnet.save('./alexnet_train_record/vvc_alexnet_customed_loss.h5')
