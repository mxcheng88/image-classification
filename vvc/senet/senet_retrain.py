...
if __name__ == '__main__':
    ...
    for train, test in sfolder.split(images, labels):
        ...
        cbks = [metric, TensorBoard(log_dir='./vgg19_train_record/vvc_vgg19_retrain/',histogram_freq=1),                LearningRateScheduler(scheduler)]
        ...
        vgg19.save('./vgg19_train_record/vvc_vgg19_retrain.h5')
