...
if __name__ == '__main__':
    ...
    for train, test in sfolder.split(images, labels):
        ...
        #cbks = [metrics, TensorBoard(log_dir='./av_train_record/av_vgg19_{:d}_{}/'.format(layers, args.dataset), write_images=1,                            histogram_freq=1),                LearningRateScheduler(scheduler)]
